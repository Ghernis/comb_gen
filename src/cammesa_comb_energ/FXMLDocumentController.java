...
//    @FXML
    ...
    @FXML
    private LineChart plot_generacion;
    @FXML
  ...
  public int compareTo(MyObject o) {
    ...
    public void cargarGraf(){
        ...
        XYChart.Series serie_en = new XYChart.Series<Date,Double>(); 
        XYChart.Series serie_eb = new XYChart.Series<Date,Double>(); 
        serie_en.setName("Energia Neta");
        serie_eb.setName("Energia Bruta");
        
//        series.getData().add(new XYChart.Data(0.0, 0.0));
//        series.getData().add(new XYChart.Data(1.2, 5.0));
//        series.getData().add(new XYChart.Data(1.0, 2.0));
//        series.getData().add(new XYChart.Data(2.0, 8.2));
//        series.getData().add(new XYChart.Data(5.5, 3.3));
        ...
        while(it.hasNext()){
            ...
            double aux2 = ((aux.getT().getTime())*1.0)/1000000000000.0;
            aux2=(aux2-1.564632)*100/0.0026748;
            
            System.out.println(aux.getT()+" aux2: "+aux2);
            serie_en.getData().add(new XYChart.Data(aux2, aux.getEn()));
            serie_eb.getData().add(new XYChart.Data(aux2, aux.getEb()));
            //System.out.println(aux.getT()+"\t"+ aux.getEn()+"\t"+aux.getEb());
        }
        
        plot_generacion.getData().addAll(serie_en,serie_eb);
        plot_generacion.setCreateSymbols(false);
